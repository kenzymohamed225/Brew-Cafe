...
<main class="container my-5 flex-grow-1">
    ...
    <div class="card hero-card mb-5 border-0 shadow-sm rounded-4 overflow-hidden">
        <div class="row g-0 align-items-center p-4 p-lg-5">
            ...
            <div class="col-lg-5 text-center mt-4 mt-lg-0">
                <img src="assets/images/coffe.jpg" class="img-fluid rounded-4 shadow" style="max-height: 320px; width: 100%; object-fit: cover;" alt="About Brew Café">
            </div>
        </div>
    </div>
    ...
    <section class="mb-5">
        <div class="row align-items-center g-5">
            <div class="col-md-6">
                <img src="assets/images/login_image.webp" class="img-fluid rounded-4 shadow-sm w-100" style="max-height: 400px; object-fit: cover;" alt="Our Story">
            </div>
            <div class="col-md-6">
